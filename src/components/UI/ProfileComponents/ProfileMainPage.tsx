      ...
      <div className="flex gap-[80px] items-center justify-center p-10 ">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-5 text-sm">
            <p>
              <strong>{userData?._count.posts}</strong> posts{" "}
            </p>
            <p>
              <strong>{userData?._count.followers}</strong> followers{" "}
            </p>
            <p>
              <strong>{userData?._count.following}</strong> followings{" "}
            </p>
          </div>
          <div>
